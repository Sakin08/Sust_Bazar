...
import { User, Mail, Phone, MapPin, Calendar, Edit3, Save, X, Camera, AlertCircle, CheckCircle, GraduationCap } from 'lucide-react';
...
const Profile = () => {
  ...
  // Update formData when user changes (load user data)
  useEffect(() => {
    if (user) {
      setFormData({
        name: user.name || '',
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-gray-900">{user.itemsPosted || 0}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Items Sold</span>
                  <span className="font-semibold text-gray-900">{user.itemsSold || 0}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Rating</span>
                  <span className="font-semibold text-gray-900">{user.rating || 'No ratings'}</span>
                </div>
              </div>
            </div>
